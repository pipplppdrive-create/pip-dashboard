...
const MODULES: ModuleDef[] = [
  {
    path: 'ringkasan',
    label: 'Ringkasan',
    description: 'Status Supabase, Google, sinkronisasi, realtime, dan environment.',
    icon: Gauge,
  ...
  },
  {
    ...
    description: 'Sumber Google Sheets per tahun, mapping kolom, sinkronisasi & snapshot.',
    icon: Table2,
  ...
  },
  {
    path: 'pegawai',
    label: 'Pegawai & PIC',
    description: 'Master pegawai: nama, tag board, NIP, jabatan, instansi, status aktif.',
    icon: Users,
  ...
  {
    path: 'board',
    label: 'Board & Aktivitas',
    description: 'Kategori, label, template pekerjaan, dan kolom board.',
    icon: SquareKanban,
  ...
  },
  {
    path: 'data-terhapus',
    label: 'Data Terhapus',
    description: 'Pulihkan atau hapus permanen data aplikasi yang di-soft-delete.',
    icon: Trash2,
  ...
  },
  {
    path: 'audit',
    label: 'Audit Log',
    description: 'Jejak lengkap: siapa, kapan, aksi apa, nilai sebelum & sesudah.',
    icon: FileClock,
  ...
  },
  {
    path: 'pengaturan',
    label: 'Pengaturan',
    description: 'Tahun aktif, identitas aplikasi, sesi, lampiran, dan backup.',
    icon: Settings,
