...
/**
 * Navigasi terkunci sesuai spesifikasi:
 * USER  = Dashboard, Pekerjaan, Rencana Kegiatan, Daftar Pegawai.
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { to: ROUTES.pegawai, label: 'Daftar Pegawai', icon: Users, roles: ['USER', 'ADMIN'] },
